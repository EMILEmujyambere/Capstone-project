...
public class elie_emile_RestaurantAdapter extends RecyclerView.Adapter<elie_emile_RestaurantAdapter.MyViewHolder> {
    Context context;
    ArrayList<elie_emile_Restaurant>restaurants;

    public elie_emile_RestaurantAdapter(Context context, ArrayList<elie_emile_Restaurant> restaurants) {
    ...
    @NonNull
    @Override
    public elie_emile_RestaurantAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.layoutRestaurant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, elie_emile_CuisineActivity.class);
