...
public class elie_emile_OrderAdapter extends RecyclerView.Adapter<elie_emile_OrderAdapter.MyViewHolder> {
    private static final String TAG = "CuisineAdapter";
    Context context;
    ArrayList<elie_emile_Cuisine>cuisines;

    public elie_emile_OrderAdapter(Context context, ArrayList<elie_emile_Cuisine> cuisines) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.elie_emile_cuisine_item, parent, false);
        elie_emile_OrderAdapter.MyViewHolder holder = new elie_emile_OrderAdapter.MyViewHolder(view);
        return holder;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.cuisine_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, elie_emile_OrderDetail.class);
